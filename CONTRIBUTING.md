# Contributing to ShardLock

Thank you for your interest in contributing to ShardLock! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/shardlock.git
   cd shardlock
   ```
...
ShardLock is built on **Java 21 LTS** using Apache Maven.

1. **Clone the repository:**
   ```bash
   git clone https://github.com/alexandrmotologa/shardlock.git
   cd shardlock
   ```
